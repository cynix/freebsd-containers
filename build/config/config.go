...
func (dp *dummyProject) BuildPackage(gh *github.Client, version, name string) error {
	return fmt.Errorf("cannot build dummy project %q version %q package %q", dp.Name, version, name)
}

func (dp *dummyProject) BuildContainer(gh *github.Client, version, name string) error {
